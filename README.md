...
```
$ git clone git@github.com:OffchainLabs/fastssz.git
```
...
```
$ go get github.com/OffchainLabs/fastssz/sszgen
```
...
goos: linux
goarch: amd64
pkg: github.com/OffchainLabs/fastssz/spectests
...
PASS
ok  	github.com/OffchainLabs/fastssz/spectests	6.608s
```
